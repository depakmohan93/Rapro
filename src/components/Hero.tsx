        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-0 items-start">
          ...
          <div className="flex-1 lg:max-w-[727px]">
            ...
            <h1 ref={headingRef} className="font-quicksand font-bold text-white mb-6 leading-[1.2]" style={{ fontSize: 'clamp(32px, 4vw, 60px)', letterSpacing: '-0.8px', maxWidth: '689px' }}>
              NRI Property Management in Chennai Since 1995
            </h1>

            {/* Updated description */}
            <p ref={subRef} className="font-poppins font-light text-white mb-0 leading-[1.6]" style={{ fontSize: '18px', maxWidth: '520px' }}>
              Trusted property management in Chennai for owners who want verified tenants, rent collection, maintenance support, and complete peace of mind.
            </p>

            {/* Stat strip */}
            <div ref={statsStripRef}>
              <StatStrip city="Chennai" />
            </div>
          </div>
          ...
          <div ref={formWrapRef} className="relative w-full lg:w-[480px] flex-shrink-0 mt-20 lg:mt-0">
            ...
            <div id="consultation-form" className="w-full">
              <iframe
                src="https://rajam-property.gridapps.in/f/68ea0d1e-9210-4036-81c1-a2ff3d713767?embed=1&utm_source=mathiverse&utm_medium=form&utm_campaign=lead-form-chennai&utm_content=rajam-property"
                width="100%"
                height="600"
                frameBorder="0"
