...
const reviews = [
  {
    ...
    text: "We've been using their services for over 3 years now. They manage three of my properties, two in Chennai and one near Thanjavur, all handled smoothly.",
  },
  {
    name: 'Vinod Krishnan',
    location: 'Singapore',
  ...
  },
  {
    ...
    text: "Rajam Property has been managing our Chennai properties for over two years. From renovations to regular photo updates, consistently excellent service.",
  },
  {
    name: 'Ramesh Nair',
    location: 'Dubai, UAE',
...
function ReviewSlider() {
  ...
  return (
    <div id="testimonials" className="w-full mt-12 md:mt-16 scroll-mt-[100px]">
      {/* Heading */}
      <p
...
export default function Hero({
  ...
  headingLine2 = 'NRI Property Management',
  headingLine3 = 'Since 1995',
  description = 'Property maintenance, tenant management, deep cleaning, renovation, legal assistance, and emergency repairs, everything managed without the hassle!',
}: HeroProps) {
